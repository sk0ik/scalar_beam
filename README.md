...
実は計算すると分かりますが先ほどのストークスパラメーターは

$$
S^2 _ 1 + S^2 _ 2 + S^2 _ 3 = 1
$$

の関係があります.これはストークスベクトルが

 $S_1, S_2, S_3$ **を軸とした単位球面上の1点を指している.**

ということを表しています.そのように考えると

**波長板のような光学素子によって偏光状態が変わるということはポアンカレ球表面上の点が移動するということ.**
...
$\theta$ 傾けた1/2波長板によって光を変調するとストークスパラメーターを上式のように変換することを意味しています.つまりポアンカレ球上の $S _ 1-S _ 2$ 平面で $2\theta$ だけ方位角が反時計回りに回転し $z$ 成分の符号が反転します.
